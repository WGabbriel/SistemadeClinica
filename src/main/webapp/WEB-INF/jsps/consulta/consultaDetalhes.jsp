      ...
      <div class="container mt-4">
        ...
        <c:choose>
          <c:when test="${consulta.prontuario != null}">
            <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#prontuarioModal">Ver
              Prontuário</button>
          </c:when>
          <c:otherwise>
            <button class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#prontuarioModal">Adicionar
              Prontuário</button>
          </c:otherwise>
        </c:choose>
      </div>
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="prontuarioModalLabel">
                <c:choose>
                  <c:when test="${consulta.prontuario != null}">Prontuário</c:when>
                  <c:otherwise>Adicionar Prontuário</c:otherwise>
                </c:choose>
              </h5>
            ...
            <div class="modal-body">
              <c:choose>
                <c:when test="${consulta.prontuario != null}">
                  <jsp:include page="../prontuario/verProntuario.jsp" />
                </c:when>
                <c:otherwise>
                  <jsp:include page="../prontuario/adicionarProntuario.jsp" />
                </c:otherwise>
              </c:choose>
            </div>
          </div>
